...
//    a) Sin utilizar Librería de Listas.
...
public class ListaArbolSL { // sin librería
    ...
    public int digitoMasCargado() {
        int mejor = 0, mayor = elem[0].cantidadTotal();
        for (int k = 1; k < 10; k++) {
            int t = elem[k].cantidadTotal();
            if (t > mayor) {
                mayor = t;
                mejor = k;
            }
    ...
    public int digitoMasDistintos() {
        int mejor = 0, mayor = elem[0].cantidadNodos();
        for (int k = 1; k < 10; k++) {
            int t = elem[k].cantidadNodos();
            if (t > mayor) {
                mayor = t;
                mejor = k;
            }
